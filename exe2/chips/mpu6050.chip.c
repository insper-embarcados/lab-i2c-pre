...
void chip_init() {
    ...
    mpu6050_register[MPUREG_WHOAMI] = 0x34;
    mpu6050_register[MPUREG_INT_ENABLE] = 0xA5;

    const i2c_config_t i2c_config = {
        .user_data = chip,
        .address = MPU6050_I2C_DEFAULT,
